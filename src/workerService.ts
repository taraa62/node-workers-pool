 ...
 *
 * якщо запит викликає помилку, то потрібно визивати reject  а не як результат
 *
 * при створенні стріма, потрібно записувати в сам стрім ключ воркера. щоб не відправити випадково на інший., якщо ж воркер не знайдений, виключення помилки
 * чанки не можуть бути перезагружені, як і всі стріми взагалі

* якщо відбулась помилка при стрімі, потрібно викидати помилку з другої сторони
 по закінченню спроб виконати задачу потрібно повертати оригінальну помилку. а не помилку по закінчення спроб


  добавити дефолтний пул , який буде виконувати динамічні запити на хендлер
 service.getHandlerObject(path: '/home/..../bb.worker.js'); без якийхось налаштувань.

 питання на рахунок таймерів для стрімів
